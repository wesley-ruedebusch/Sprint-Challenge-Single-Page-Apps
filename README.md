...
> Answer: Client side routing is beneficial because it will cut down on page reload time and stop the entire page from reloading when just one component needs to be reloaded.
